...
FOCAL_LENGTH_PIXELS =  452  # Approximate focal length in pixels (calibrate for your camera)
...
MAVLINK_CONNECTION = '/dev/ttyAMA0'  # UART on Pi 5 GPIO 8/10 (try /dev/ttyAMA0 if this doesn't work)
